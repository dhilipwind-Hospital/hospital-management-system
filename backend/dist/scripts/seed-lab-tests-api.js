...
const labTests = [
    ...
    },
    {
        ...
        units: 'N/A',
        cost: 900,
        turnaroundTimeMinutes: 2880,
        isActive: true
    }
];
async function seedLabTestsViaAPI() {
    var _a, _b, _c, _d, _e, _f, _g;
    try {
        console.log('🔬 Seeding lab tests via API...\n');
        ...
        for (const testData of labTests) {
            try {
                await axios_1.default.post(`${API_URL}/lab/tests`, testData, {
                ...
                if (((_a = error.response) === null || _a === void 0 ? void 0 : _a.status) === 400 && ((_d = (_c = (_b = error.response) === null || _b === void 0 ? void 0 : _b.data) === null || _c === void 0 ? void 0 : _c.message) === null || _d === void 0 ? void 0 : _d.includes('already exists'))) {
                    ...
                    console.error(`❌ Error creating ${testData.name}:`, ((_f = (_e = error.response) === null || _e === void 0 ? void 0 : _e.data) === null || _f === void 0 ? void 0 : _f.message) || error.message);
                }
            }
        }
